package org.martinrgb.interpolator;
...
public class InterpolatorConfigurationView extends FrameLayout {
    ...
    public InterpolatorConfigurationView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private View generateHierarchy(Context context) {
        ...
        //DurationLabel.setTypeface(myTypeface);
